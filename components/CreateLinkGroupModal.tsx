...
interface CreateLinkGroupModalProps {
  onClose: () => void;
  onGroupCreated: (group: LinkGroup) => void;
}

export default function CreateLinkGroupModal({ onClose, onGroupCreated }: CreateLinkGroupModalProps) {
